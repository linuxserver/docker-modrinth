pipeline {
  ...
  environment {
    ...
    EXT_USER = 'modrinth'
    EXT_REPO = 'code'
    BUILD_VERSION_ARG = 'MODRINTH_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-modrinth'
    CONTAINER_NAME = 'modrinth'
    DOCKERHUB_IMAGE = 'linuxserver/modrinth'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/modrinth'
    PR_DOCKERHUB_IMAGE = 'lspipepr/modrinth'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'false'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-modrinth/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-modrinth\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-modrinth\" \
          --label \"org.opencontainers.image.version=${EXT_RELEASE_CLEAN}-ls${LS_TAG_NUMBER}\" \
          --label \"org.opencontainers.image.revision=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.vendor=linuxserver.io\" \
          --label \"org.opencontainers.image.licenses=GPL-3.0-only\" \
          --label \"org.opencontainers.image.ref.name=${COMMIT_SHA}\" \
          --label \"org.opencontainers.image.title=Modrinth\" \
          --label \"org.opencontainers.image.description=[Modrinth App](https://modrinth.com/) is a unique, open source launcher that allows you to play your favorite mods, and keep them up to date, all in one neat little package.\" \
